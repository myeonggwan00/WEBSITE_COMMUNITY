...
public class LoginService {
     ...
     */
    public Optional<Member> findLoginMemberById(LoginMember loginMember) {
    ...
    public String processLogin(LoginMember loginMember, BindingResult bindingResult,
        ...
        Optional<Member> optionalFindMember = findLoginMemberById(loginMember);
    ...
    public void processRememberIdCookie(LoginMember loginMember, HttpServletResponse response) {
        if(loginMember.isRememberId()) {
            createCookie(response, loginMember);
        } else {
     ...
     * 쿠키를 생성하는 메서드
     */
    private void createCookie(HttpServletResponse response, LoginMember loginMember) {
